...
const JIRA_ADMIN_BASE_URL = `https://api.atlassian.com`;
...
export const createTicket = async (summary: string, priority: string, pageLink: string, template: string, userEmail: string) => {
    const issueData = {
        fields: {
